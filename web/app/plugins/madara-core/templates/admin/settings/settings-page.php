<?php
	...
	$webpush_notifcation_content = isset( $optiops['webpush_noti_content'] ) ? $options['webpush_noti_content'] : '%manga% has new chapter %chapter%!';
...
<div class="wrap wp-manga-wrap">
    ...
    <form method="post">
            ...
            <tr>
                ...
                <td>
                    <p>
                        ...
                        <br/>
                        <span class="description"> <?php esc_html_e( 'Change slug for Single Manga, default slug is <strong> manga </strong>.', WP_MANGA_TEXTDOMAIN ); ?> </span>
                    </p>
                </td>
            </tr>
		...
		<p style="color:#FF0000"><?php _e('Remember to save the <b>Settings > Permalink</b> setting again if you change slug values',WP_MANGA_TEXTDOMAIN);?></p>
