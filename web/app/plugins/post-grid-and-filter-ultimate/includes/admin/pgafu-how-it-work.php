						...
						<div class="postbox wpos-pro-box">
							...
							<div class="inside">
								<ul class="wpos-list">
									...
									<li><?php _e('Elementor, Beaver and SiteOrigin Page Builder Support.', 'post-grid-and-filter-ultimate'); ?> <span class="wpos-new-feature">New</span></li>
									<li><?php _e('Divi Page Builder Native Support.', 'post-grid-and-filter-ultimate'); ?> <span class="wpos-new-feature">New</span></li>
